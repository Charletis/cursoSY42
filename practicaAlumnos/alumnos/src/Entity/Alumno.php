 ...
 * Alumno
 *
 * @ORM\Table(name="alumno", uniqueConstraints={@ORM\UniqueConstraint(name="UNIQ_1435D52DE7927C74", columns={"email"}), @ORM\UniqueConstraint(name="UNIQ_1435D52D67E69CFE", columns={"n_expediente"}), @ORM\UniqueConstraint(name="UNIQ_1435D52DC1E70A7F", columns={"telefono"})}, indexes={@ORM\Index(name="IDX_1435D52D91A441CC", columns={"grado_id"})})
 * @ORM\Entity
 */
class Alumno
{
